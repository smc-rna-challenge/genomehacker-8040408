SMC-RNA Challenge Entry: genomehacker-8040408
========================================================
...
```bash
# Clone this repo
git clone https://github.com/smc-rna-challenge/genomehacker-8040408
cd genomehacker-8040408
...
- [quay.io/smc-rna-challenge/genomehacker-8040408-gstruct-fusion:1.0.0](https://quay.io/smc-rna-challenge/genomehacker-8040408-gstruct-fusion:1.0.0)

- [quay.io/smc-rna-challenge/genomehacker-8040408-gsnap:1.0.0](https://quay.io/smc-rna-challenge/genomehacker-8040408-gsnap:1.0.0)
...
Split-read mapping, read-pair analysis, realignment
...
Similarity, Splice prob, Realignment quality, Support, Subsumption
...
Inter-chromosomal, Intra-chromosomal, read-through, Self-fusion, Scrambling events, Distinguishes read-through standard and alt, Alt 5' and 3' exons
...
Adaptor sequences remaining in the reads, The presence of few reads spanning splice junctions, The presence of many multiply-mapped reads -- i.e. those reads having more than one match in the reference
...
[data]: https://www.synapse.org/#!Synapse:syn9878854
